...
export function AdminProductForm({ initial, saving, error, getToken, onCancel, onSubmit }) {
  ...
  function handleSubmit(e) {
    ...
    const body = {
      ...
      cloudinaryPublicId: cloudinaryPublicId.trim() || null,
      active,
    };
    ...
    if (initial) {
      ...
      if ((body.cloudinaryPublicId ?? null) !== (initial.cloudinaryPublicId ?? null)) {
        patch.cloudinaryPublicId = body.cloudinaryPublicId;
      }
      ...
      <div className="form-control w-full">
        ...
        <input
          ...
          onChange={(e) => {
            ...
            if (v !== imageUrl) setCloudinaryPublicId("");
            setImageUrl(v);
          }}
          placeholder="https://..."
        />
        ...
        {imageUrl ? (
          <div className="mt-2 overflow-hidden rounded-lg border border-base-300 bg-base-200 p-2">
            <img
              src={getCloudinaryUrl(imageUrl, { width: 400 })}
              alt=""
